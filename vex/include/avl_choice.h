...
float
avl_choice(const float sequence[])
{
    ...
    return sequence[avl_randrange(42.42 * sequenceLength, 0, sequenceLength)];
}

int
avl_choice(const int sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
...
string
avl_choice(const string sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
...
vector2
avl_choice(const vector2 sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
...
vector
avl_choice(const vector sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
...
vector4
avl_choice(const vector4 sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
...
matrix2
avl_choice(const matrix2 sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
...
matrix3
avl_choice(const matrix3 sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
...
matrix
avl_choice(const matrix sequence[])
{
    sequenceLength = len(sequence);
    if (sequenceLength == 0)
    {
